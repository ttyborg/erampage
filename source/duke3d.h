...
#define GAME_RA (g_scriptVersion==14)
...
#define BYTEVERSION (BYTEVERSION_JF+(GAME_RA?1:(VOLUMEONE<<1)))    // JBF 20040116: different data files give different versions
...
// Player Actions.
    ...
    enum DukeWeapon_t {
        ...
        CROSSBOW_WEAPON = 5,
        THROWSAW_WEAPON = 6,
        ALIENARMGUN_WEAPON = 7,
        POWDERKEG_WEAPON = 8,
        TEATGUN_WEAPON = 9,
        HANDREMOTE_WEAPON = 10,
        BUZSAW_WEAPON = 11,
        BOWLINGBALL_WEAPON = 12,
...
#define SYNCFIFOSIZ 1024
    ...
    extern int32_t g_numBUZSAWBounces,g_rpgBlastRadius,g_pipebombBlastRadius,g_tripbombBlastRadius;
    extern int32_t g_ALIENARMGUNBlastRadius,g_morterBlastRadius,g_bouncemineBlastRadius,g_seenineBlastRadius;
...
#define NAM_GRENADE_LIFETIME_VAR    30
    ...
    enum WeaponFlags_t {
        ...
        WEAPON_GLOWS               = 2,     // weapon 'glows' (ALIENARMGUN and grower)
