...
GAMEEXEC_STATIC int32_t X_DoExecute(int32_t once) {
    ...
    while (!once) {
        if (vm.g_killitFlag + vm.g_returnFlag)
            return 1;
        ...
        case CON_SSP:
            insptr++;
            {
                ...
                case CON_OPERATESECTORS:
                    ...
                    break;
                case CON_OPERATEACTIVATORS:
                    if ((var2<0 || var2>=playerswhenstarted) /* && g_scriptSanityChecks */) {
...
nullquote:
        ...
        case CON_ADDINVENTORY:
            ...
            case GET_ACCESS:
                ...
                // j = 0; //? let instances of the same kind of key to be taken and to trigger different doors
                break;
