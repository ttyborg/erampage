...
void ExtShowSectorData(int16_t sectnum) { //F5
    ...
    PrintStatus("ALIENARMGUN =",numsprite[ALIENARMGUNSPRITE],x,y+7,11);
    ...
    PrintStatus("BUZSAWray=",numsprite[BUZSAWAMMO],x,y+10,11);
    PrintStatus("",multisprite[BUZSAWAMMO],x2,y+10,9);
        ...
        while (keystatus[KEYSC_ESC]==0 && keystatus[KEYSC_Q]==0 && keystatus[KEYSC_F1]==0) {
            ...
            if (keystatus[KEYSC_T]) {  // goto table of contents
                ...
                for (i=curline, j=0; i < helppage[curhp]->numlines; i++) {
                    if (emptyline(helppage[curhp]->line[i])) {
                        j=1;
                        continue;
                    }
                    if (j==1 && !emptyline(helppage[curhp]->line[i])) {
                        j=2;
                        break;
                    }
                }
...
static void Keys3d(void) {
    ...
    */
    ...
    if (keystatus[KEYSC_CAPS] || (keystatus[KEYSC_QUOTE] && keystatus[KEYSC_Z])) {
        ...
        switch (zmode) {
        case 0:
            message("Zmode = Gravity");
            break;
        case 1:
            message("Zmode = Locked/Sector");
            break;
        case 2:
            message("Zmode = Locked/Free");
            break;
        }
        ...
        for (i=0; i<3; i++)
            for (j=0; i==1 ? j<6 : j<7; j++) {
                ...
                if (i==0) {
                    switch (j) {
                    case 0:
                        k = sprite[gs_cursprite].x;
                        break;
                    case 1:
                        k = sprite[gs_cursprite].y;
                        break;
                    case 2:
                        k = sprite[gs_cursprite].z;
                        break;
                    case 3:
                        k = sprite[gs_cursprite].sectnum;
                        break;
                    case 4:
                        k = sprite[gs_cursprite].statnum;
                        break;
                    case 5:
                        k = sprite[gs_cursprite].hitag;
                        break;
                    case 6:
                        k = sprite[gs_cursprite].lotag;
                        break;
                    }
                }
                if (i==1) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        k = sprite[gs_cursprite].shade;
                        break;
                    case 2:
                        k = sprite[gs_cursprite].pal;
                        break;
                    case 3:
                        k = gs_sprite[1][3];
                ...
                if (i==2) {
                    switch (j) {
                    case 0:
                        k = sprite[gs_cursprite].ang;
                        break;
                    case 1:
                        k = sprite[gs_cursprite].xvel;
                        break;
                    case 2:
                        k = sprite[gs_cursprite].yvel;
                        break;
                    case 3:
                        k = sprite[gs_cursprite].zvel;
                        break;
                    case 4:
                        k = sprite[gs_cursprite].owner;
                        break;
                    case 5:
                        k = sprite[gs_cursprite].clipdist;
                        break;
                    case 6:
                        k = sprite[gs_cursprite].extra;
                        break;
                    }
                }
